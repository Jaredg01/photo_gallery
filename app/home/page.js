...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-gray-200">
      <header className="py-10 px-8 flex items-center justify-between bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 shadow-lg rounded-b-3xl border-b-4 border-blue-500">
        <div className="text-center flex-1">
          ...
          <p className="text-lg text-white/90 font-medium drop-shadow">Upload and view your favorite images</p>
        </div>
        {user && (
      ...
      <footer className="py-6 text-center text-base font-semibold bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 text-white shadow-inner rounded-t-3xl border-t-4 border-blue-500 tracking-wide drop-shadow-lg">
        <span style={{fontFamily: "'Pacifico', cursive, 'Comic Sans MS', 'Brush Script MT', sans-serif", fontSize: '1.3rem', letterSpacing: '0.04em'}}>© Photo Gallery</span>
      </footer>
    </div>
  );
}
